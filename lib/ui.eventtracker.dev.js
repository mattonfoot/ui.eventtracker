...
!(function ( $, undefined ) {
  ...
  * =================================== */
    ...
    * ================== */
    ...
    $(document)
        .on('click.data-api.bs', 'a[data-track], button[data-track], [type="submit"][data-track], button[data-track], [data-track] a, [data-track] button, [data-track] [type="submit"], .tophat a', function ( e ) {
            var $this = $(this);
